...
const EXCHANGES: Exchange[] = ['BingX', 'MEXC', 'Bitunix', 'Bitget', 'OKX', 'Binance', 'LBank'];
...
const THEME = {
  ...
  OKX: {
    ...
    headerBg: 'from-zinc-500/10 via-transparent to-transparent',
    badge: 'bg-zinc-500/10 text-zinc-100 ring-zinc-500/30',
    progress: 'from-zinc-400 to-zinc-200',
    btn: 'from-zinc-500 to-zinc-400',
  ...
  Binance: {
    ...
    headerBg: 'from-yellow-500/10 via-transparent to-transparent',
    badge: 'bg-yellow-500/10 text-yellow-400 ring-yellow-500/30',
